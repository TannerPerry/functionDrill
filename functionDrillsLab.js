...
let oddChecker = thatsOdd(987987987)
...
function sortedArr(arr){
  ...
  for (let i = 0; i < arr.length; i++) {
    if (arr[i] < arr[i + 1]) {
      console.log(sampleArray[i],"&",sampleArray[i + 1],"is in order")
    } else if (arr[i] > arr[i + 1]) {
      console.log(sampleArray[i],"&",sampleArray[i + 1],"are not in order")
      return arrIsSorted = false
    } else {
      console.log("Array is in order")
      return arrIsSorted
    }
  }
...
console.log(sortedArr(sampleArray))
